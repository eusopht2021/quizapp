...
//   int mathManiaSeconds = 60;
//   int normalSeconds = 15;
//   int seconds = 0;
//   double totalSecondsToCompleteQuiz = 0;
//   CountdownController controller = CountdownController();
//   AssetsAudioPlayer assetsAudioPlayer = AssetsAudioPlayer();
//
//   // AnimationController topContainerAnimationController =
//   // AnimationController(
//   //   vsync: this,
...
//                 return _loader();
//               } else if (state is QuestionsFetchFailure) {
//                 return const Text('Failed to get questions');
//               }
...
//                                 Expanded(
//                                   flex: 2,
//                                   child: _countDownTimer(questions),
//                                 ),
//                                 Expanded(
//                                   flex: 8,
//                                   child: Column(
...
//         //   ),
//         // );
//         log('Option #$answerIndex tapped');
//         if (currentQuestionIndex == questions.length - 1) {
//           //TODO add quiz submit logic
//
//         } else {
//           setState(() {
//             currentQuestionIndex++;
...
//           decoration: BoxDecoration(
//             color: answerIndex == selectedOption
//                 ? Constants.grey5
//                 : Constants.white,
//             border: Border.all(
...
//             quizType: widget.quizType,
//             answer: option.title!,
//             backgroundColor: answerIndex == selectedOption
//                 ? Constants.grey5
//                 : Constants.white,
//           ),
//         ),
...
//       AnswerOption answerOption, String correctAnswerId) {
//     bool showAnswerCorrectness =
//         context.read<SystemConfigCubit>().getShowCorrectAnswerMode();
//     log('Answer tapped!');
...
//         submitAnswer(answerOption.id!);
//
//         // topContainerAnimationController.forward();
//
//         //play sound
//         if (correctAnswerId == answerOption.id) {
...
//     totalSecondsToCompleteQuiz = totalSecondsToCompleteQuiz +
//         UiUtils.timeTakenToSubmitAnswer(
//             animationControllerValue: 10, quizType: widget.quizType);
//   }
//
//   void submitAnswer(String submittedAnswer) async {
//     if (!context
...
//   }
//
//   TitleText _questionNumber(List<Question> questions) {
//     return TitleText(
...
//   }
//
//   Countdown _countDownTimer(List<Question> questions) {
//     return Countdown(
//       seconds: seconds,
...
//       {required QuizTypes quizType, required String? question}) {
...
//     showDialog(
//       context: context,
//       builder: (_) => const ExitGameDailog(),
//     ).then(
//       (value) => isExitDialogOpen = false,
//     );
//   }
// }
